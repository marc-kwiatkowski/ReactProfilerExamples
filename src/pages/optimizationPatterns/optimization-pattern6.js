...
export function OptimizationPattern6() {
    return (
      <div>
        <ButtonHeader prevPage="/optimizationPattern5" nextPage="/toSummarize" />
        ...
        <p>^^saved ~40ms with a 2 line change moving the React.useContext to a more specific spot</p>
