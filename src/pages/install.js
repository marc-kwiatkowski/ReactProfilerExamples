...
export function Install() {
    return (
      <div>
        ...
        <p>Firefox installation: <Link url="https://microsoftedge.microsoft.com/addons/detail/react-developer-tools/gpphkfbcpidddadnkolkpfckpihlkkil" text="Edge React Developer Tools" /></p>
      </div>
    );
  }